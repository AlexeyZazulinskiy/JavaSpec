...
public class MagazineModel {
    public static Toy getRandom(List<Toy> listToy) { // возвращает рандомную ирушку с учетом шанса
        ...
        int max = 0;
        int imax = 0;
        for (int i = 0; i < listToy.size(); i++) { // умножаем рандомное число на шанс выпадения каждой игрушки и
                                                   // записываем в массив
    ...
    public static void receiveWinToy(Queue<Toy> toyWinList) throws IOException { // записывает в фаил первую игрушку в
                                                                                 // списке
